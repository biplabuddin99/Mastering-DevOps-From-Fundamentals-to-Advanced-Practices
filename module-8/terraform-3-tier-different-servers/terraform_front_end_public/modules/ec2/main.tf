...
resource "aws_instance" "frontend" {
  ...
  # EIP association causes AWS to report associate_public_ip_address = true
  # even though we set false. Ignore this attribute to prevent an infinite
  # destroy/recreate loop on every apply.
  lifecycle {
